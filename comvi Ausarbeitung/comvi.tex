...
\keywords{Clustering, Dimensionality Reduction, Similarity, Feature Extraction, Visualization, Large High-Resolution Display, MegaMol, Powerwall}
...
% More about the comparison of the different methods in%\ref{}.
