...
\section{Clustering}
This section describes our whole process to clustering the image data.
...
We ended up using a higher dimensional feature vector described in \ref{sec:findvec} to determine the similarirty between two protein maps because we didnt manage to train a custom model in the given timeframe, due to inexperience \todo{this can be said better}and non existance of labeled data.
...
\subsection{Finding a feature vector to cluster the images}\label{sec:findvec}
