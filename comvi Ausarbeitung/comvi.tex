...
We did not end up using the shape features, because we could notice any improvement over the other features that we used, but since we put substantial effort into computing these features, so we wanted to describe our process here.
